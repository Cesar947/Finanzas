...
Algoritmo DescuentoComercial
	...
	//Datos de entrada
	Definir TEAc, TEP, d, TEAm, valorNominal, valorConRetencion, periodoEnDias, valorNeto, Dscto, valorRecibido, retencion como Reales
	
	Escribir "Ingrese la TEA compensatoria:"
	Leer TEAc
